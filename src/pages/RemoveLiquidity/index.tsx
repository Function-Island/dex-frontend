...
import { Currency, currencyEquals, PULSE, Percent, WPLS } from '@functionisland-dex/sdk'
...
export default function RemoveLiquidity({
  ...
  async function onRemove() {
    ...
    const currencyBIsPLS = currencyB === PULSE
    const oneCurrencyIsPLS = currencyA === PULSE || currencyBIsPLS
    ...
    if (approval === ApprovalState.APPROVED) {
      ...
      if (oneCurrencyIsPLS) {
        ...
        args = [
          ...
          amountsMin[currencyBIsPLS ? Field.CURRENCY_A : Field.CURRENCY_B].toString(),
          amountsMin[currencyBIsPLS ? Field.CURRENCY_B : Field.CURRENCY_A].toString(),
          account,
              ...
              <>
                ...
                <LightCard>
                  <AutoColumn gap="10px">
                    ...
                    {chainId && (oneCurrencyIsWPLS || oneCurrencyIsPLS) ? (
