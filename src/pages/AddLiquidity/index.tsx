...
import { Currency, currencyEquals, PULSE, TokenAmount, WPLS } from '@functionisland-dex/sdk'
  ...
  async function onAdd() {
    ...
    if (currencyA === PULSE || currencyB === PULSE) {
      ...
      args = [
        ...
        amountsMin[tokenBIsPLS ? Field.CURRENCY_A : Field.CURRENCY_B].toString(), // token min
        amountsMin[tokenBIsPLS ? Field.CURRENCY_B : Field.CURRENCY_A].toString(), // pls min
        account,
        deadline.toHexString()
      ]
      value = BigNumber.from((tokenBIsPLS ? parsedAmountB : parsedAmountA).raw.toString())
    } else {
