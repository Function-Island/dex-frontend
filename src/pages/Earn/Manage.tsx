...
import { JSBI, TokenAmount, PULSE } from '@functionisland-dex/sdk'
...
export default function Manage({
  ...
  const token = currencyA === PULSE ? tokenB : tokenA
  const WPLS = currencyA === PULSE ? tokenA : tokenB
  const backgroundColor = useColor(token)

  // get WPLS value of staked LP tokens
  const totalSupplyOfStakingToken = useTotalSupply(stakingInfo?.stakedAmount?.token)
  let valueOfTotalStakedAmountInWPLS: TokenAmount | undefined
  if (totalSupplyOfStakingToken && stakingTokenPair && stakingInfo && WPLS) {
    ...
    <PageWrapper gap="lg" justify="center">
      ...
      <PositionInfo gap="lg" justify="center" dim={showAddLiquidityButton}>
        <BottomSection gap="lg" justify="center">
          ...
          <StyledBottomCard dim={stakingInfo?.stakedAmount?.equalTo(JSBI.BigInt(0))}>
            ...
            <AutoColumn gap="sm">
              <RowBetween>
                <div>
                  <TYPE.black>Your unclaimed iDAI</TYPE.black>
                </div>
        ...
        <TYPE.main style={{ textAlign: 'center' }} fontSize={14}>
          ...
          When you withdraw, the contract will automagically claim iDAI on your behalf!
        </TYPE.main>
