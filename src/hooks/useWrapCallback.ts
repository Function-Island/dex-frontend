import { Currency, currencyEquals, PULSE, WPLS } from '@functionisland-dex/sdk'
...
export default function useWrapCallback(
  ...
  return useMemo(() => {
    ...
    if (inputCurrency === PULSE && currencyEquals(WPLS[chainId], outputCurrency)) {
      return {
    ...
    } else if (currencyEquals(WPLS[chainId], inputCurrency) && outputCurrency === PULSE) {
      return {
