...
import { JSBI, Percent, Router, SwapParameters, Trade, TradeType } from '@functionisland-dex/sdk'
                ...
                return contract.callStatic[methodName](...args, options)
                  ...
                  .catch(callError => {
                    ...
                    switch (callError.reason) {
                      case 'SwapRouter: INSUFFICIENT_OUTPUT_AMOUNT':
                      case 'SwapRouter: EXCESSIVE_INPUT_AMOUNT':
                        errorMessage =
