describe('Add Liquidity', () => {
  it('loads the two correct tokens', () => {
    ...
    cy.get('#add-liquidity-input-tokenb .token-symbol-container').should('contain.text', 'PLS')
  })

  it('does not crash if PLS is duplicated', () => {
    cy.visit('/add/0xc778417E063141139Fce010982780140Aa0cD5Ab-0xc778417E063141139Fce010982780140Aa0cD5Ab')
    cy.get('#add-liquidity-input-tokena .token-symbol-container').should('contain.text', 'PLS')
    cy.get('#add-liquidity-input-tokenb .token-symbol-container').should('not.contain.text', 'PLS')
  })
  ...
  it('redirects /add/WPLS-token to /add/WPLS-address/token', () => {
  ...
  it('redirects /add/token-WPLS to /add/token/WPLS-address', () => {
    cy.visit('/add/0xF9bA5210F91D0474bd1e1DcDAeC4C58E359AaD85-0xc778417E063141139Fce010982780140Aa0cD5Ab')
    cy.url().should(
      'contain',
